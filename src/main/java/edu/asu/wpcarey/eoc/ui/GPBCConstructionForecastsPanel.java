...
public class GPBCConstructionForecastsPanel extends JPanel implements ActionListener {
	...
	private Object[] residentialColumns = new Object[] { "Organization", "Single-family permits",
			"Multi-family permits", "Apartment Vacancy (Q4 %)", "Apartment Absorption (Units)", "Enabled",
			"Is Actual?" };
	...
	private void initiateTable() {
		...
		if (getQuarter().equals("Q1")) {
			...
			tableMap.put(DAOUtils.GBPCConstructionType.RESIDENTIAL.name() + String.valueOf(currentYear),
					residentialCurrent);
			...
			tableMap.put(DAOUtils.GBPCConstructionType.RESIDENTIAL.name() + String.valueOf(currentYear + 1),
					residentialNext);

			officeCurrent = prepareTable(currentYear, DAOUtils.GBPCConstructionType.OFFICE, this.restColumns,
					dtmOfficeCurrent);
			...
			retailCurrent = prepareTable(currentYear, DAOUtils.GBPCConstructionType.RETAIL, this.restColumns,
					dtmRetailCurrent);
			...
			industrialCurrent = prepareTable(currentYear, DAOUtils.GBPCConstructionType.INDUSTRIAL, this.restColumns,
					dtmIndustrialCurrent);
			tableMap.put(DAOUtils.GBPCConstructionType.INDUSTRIAL.name() + String.valueOf(currentYear),
					industrialCurrent);
			industrialNext = prepareTable(currentYear + 1, DAOUtils.GBPCConstructionType.INDUSTRIAL, this.restColumns,
					dtmIndustrialNext);
			tableMap.put(DAOUtils.GBPCConstructionType.INDUSTRIAL.name() + String.valueOf(currentYear + 1),
					industrialNext);
			...
			tableMap.put(DAOUtils.GBPCConstructionType.RESIDENTIAL.name() + String.valueOf(currentYear + 2),
					residentialNextToNextYear);

			officeNextToNextYear = prepareTable(currentYear + 2, DAOUtils.GBPCConstructionType.OFFICE, this.restColumns,
					dtmOfficeNextToNextYear);
			tableMap.put(DAOUtils.GBPCConstructionType.OFFICE.name() + String.valueOf(currentYear + 2),
					officeNextToNextYear);

			retailNextToNextYear = prepareTable(currentYear + 2, DAOUtils.GBPCConstructionType.RETAIL, this.restColumns,
					dtmRetailNextToNextYear);
			tableMap.put(DAOUtils.GBPCConstructionType.RETAIL.name() + String.valueOf(currentYear + 2),
					retailNextToNextYear);
			...
			tableMap.put(DAOUtils.GBPCConstructionType.INDUSTRIAL.name() + String.valueOf(currentYear + 2),
					industrialNextToNextYear);
		} else {
			residentialCurrent = prepareTable(currentYear, DAOUtils.GBPCConstructionType.RESIDENTIAL,
					this.residentialColumns, dtmResidentialCurrent);
			tableMap.put(DAOUtils.GBPCConstructionType.RESIDENTIAL.name() + String.valueOf(currentYear),
		...
		if (getQuarter().equals("Q1")) {
			this.addButtonAndTable(residential, String.valueOf(currentYear + 2), residentialNextToNextYear,
					buttonResidentialNextToNextYear);
			this.addButtonAndTable(office, String.valueOf(currentYear + 2), officeNextToNextYear,
					buttonOfficeNextToNextYear);
			this.addButtonAndTable(retail, String.valueOf(currentYear + 2), retailNextToNextYear,
					buttonRetailNextToNextYear);
			this.addButtonAndTable(industrial, String.valueOf(currentYear + 2), industrialNextToNextYear,
					buttonIndustrialNextToNextYear);
		}
